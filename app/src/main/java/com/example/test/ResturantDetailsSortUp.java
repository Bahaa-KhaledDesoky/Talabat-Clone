...
public class ResturantDetailsSortUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resturant_details_sort_up);
        ...
        itemDapter item = new itemDapter (ResturantDetailsSortUp.this,cursor,idcustomer);
        recyclerView=findViewById(R.id.mealss);
        recyclerView.setAdapter(item);
        LinearLayoutManager linearLayoutManager =new LinearLayoutManager(this);
        Toast.makeText(ResturantDetailsSortUp.this,""+item.getItemCount(),Toast.LENGTH_LONG).show();
    ...
    public void sort_down(View view) {
        Intent intent=new Intent(ResturantDetailsSortUp.this,ResturantDetailsSortDown.class);
        intent.putExtra(resturantConstant.RESTURANT_ID,id);
        startActivity(intent);
    }

    public void random(View view) {
        Intent intent=new Intent(ResturantDetailsSortUp.this,ResturantDetails.class);
        intent.putExtra(resturantConstant.RESTURANT_ID,id);
        startActivity(intent);
    }

    public void searchmeals(View view) {
        Intent intent=new Intent(ResturantDetailsSortUp.this,SearchinMeals.class);
        intent.putExtra(resturantConstant.RESTURANT_ID,id);
