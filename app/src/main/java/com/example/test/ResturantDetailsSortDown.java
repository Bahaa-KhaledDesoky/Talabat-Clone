...
public class ResturantDetailsSortDown extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resturant_details_sort_down);
        ...
        Cursor cursor =  getContentResolver().query(data.mealConstant.MEAL_URI,projection,selectionmeal,selectionArgs,mealConstant.MEAL_NAME+" DESC");
        itemDapter item = new itemDapter (ResturantDetailsSortDown.this,cursor,idcustomer);
        recyclerView=findViewById(R.id.mealss);
        recyclerView.setAdapter(item);
        LinearLayoutManager linearLayoutManager =new LinearLayoutManager(this);
        Toast.makeText(ResturantDetailsSortDown.this,""+item.getItemCount(),Toast.LENGTH_LONG).show();
        recyclerView.setLayoutManager(linearLayoutManager);
        Toast.makeText(this,""+item.getItemCount(),Toast.LENGTH_LONG).show();
    }

    public void sort_up(View view) {
        Intent intent=new Intent(ResturantDetailsSortDown.this,ResturantDetailsSortUp.class);
        intent.putExtra(resturantConstant.RESTURANT_ID,id);
        startActivity(intent);
    }
    public void random(View view) {
        Intent intent=new Intent(ResturantDetailsSortDown.this,ResturantDetails.class);
        intent.putExtra(resturantConstant.RESTURANT_ID,id);
        startActivity(intent);
    }

    public void searchmeals(View view) {
        Intent intent=new Intent(ResturantDetailsSortDown.this,SearchinMeals.class);
        intent.putExtra(resturantConstant.RESTURANT_ID,id);
