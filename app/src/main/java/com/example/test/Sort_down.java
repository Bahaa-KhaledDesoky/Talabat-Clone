...
public class Sort_down extends AppCompatActivity {
    String Ownerid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sort_down);
...
//////////////// resturant data
        ...
        itemDapter item = new itemDapter (Sort_down.this,cursor);
        recyclerView=findViewById(R.id.meals);
        recyclerView.setAdapter(item);
        LinearLayoutManager linearLayoutManager =new LinearLayoutManager(this);
        Toast.makeText(Sort_down.this,""+item.getItemCount(),Toast.LENGTH_LONG).show();
    ...
    public void movetoAddMeals(View view) {
        ...
        Intent intent = new Intent(Sort_down.this, AddMeals.class);
        intent.putExtra("USER_ID",Ownerid);
        startActivity(intent);
    }

    public void sort_up(View view) {
        Intent intent = new Intent(Sort_down.this,Sort_up.class);
        intent.putExtra("USER_ID",Ownerid);
        startActivity(intent);
    }

    public void sort_random(View view) {
        Intent intent = new Intent(Sort_down.this,OwnerHome.class);
        intent.putExtra("USER_ID",Ownerid);
        startActivity(intent);
    }
}
